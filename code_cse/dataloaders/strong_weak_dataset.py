...
from .volumentations import Compose, RandomGamma, GaussianNoise
...
def inspect_data(tensor, name=None):
    print(name, tensor.shape, tensor.dtype, tensor.min(), tensor.max())

class StrongWeakLAHeart(Dataset):
    """ LA Dataset """
    def __init__(self, base_dir=None, split='train', num=None, transform=None, args=None):
        self.args = args
        self._base_dir = base_dir
        self.transform = transform
        self.sample_list = []
